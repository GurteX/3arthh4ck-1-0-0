...
import me.earth.earthhack.impl.modules.movement.accel.Acceleration;
...
import me.earth.earthhack.impl.modules.other.autokill.AutoKill;
import me.earth.earthhack.impl.modules.other.autokit.AutoKit;
import me.earth.earthhack.impl.modules.other.c16b0ef.C892ELbNC299187;
import me.earth.earthhack.impl.modules.other.f90ebnc.a25hbce086ec;
import me.earth.earthhack.impl.modules.other.fasthole.FastHole;
...
public class ModuleManager extends IterationRegister<Module>
{
    public void init()
    {
        ...
        this.forceRegister(new Acceleration());
        ...
        this.forceRegister(new AutoKill());
        this.forceRegister(new FastHole());
        this.forceRegister(new AutoKit());
        this.forceRegister(new a25hbce086ec());
        this.forceRegister(new C892ELbNC299187());
