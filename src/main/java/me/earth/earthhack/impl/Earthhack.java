...
public class Earthhack implements Globals
{
    ...
    public static final String VERSION = "1.0.3+alpha-35.2b1e947084";
    ...
    {
        LOGGER.info("\n\nInitializing Phobos.eu");
        SplashScreenHelper.setSplashScreen("Initializing Phobos.eu", 7);
        Display.setTitle(NAME + " - " + VERSION);
        Managers.load();
        LOGGER.info("Prefix is " + Commands.getPrefix());
        SplashScreenHelper.clear();
        LOGGER.info("\nPhobos.eu initialized.\n");
    }
