...
public class CrystalChams extends Module {
    ...
    public Setting<Boolean> changeSpeed =
            register(new BooleanSetting("ChangeSpeed", false));
    public Setting<Float> spinSpeed =
            register(new NumberSetting<>("SpinSpeed", 1.0f, 0.0f, 10.0f));
    public Setting<Float> floatFactor =
            register(new NumberSetting<>("FloatFactor", 1.0f, 0.0f, 1.0f));
